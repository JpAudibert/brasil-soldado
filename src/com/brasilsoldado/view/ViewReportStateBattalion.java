 ...
 * @author deusjp
 */
public class ViewReportStateBattalion extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewReportStateBattalion
     */
    public ViewReportStateBattalion() {
        initComponents();
        combo.popularCombo("state", "idstate", "name", this.fkStateId, "");
    }

    public ViewReportStateBattalion(String email) {
        initComponents();
        this.email = email;
        combo.popularCombo("state", "idstate", "name", this.fkStateId, "");
    }
    ...
    private void initComponents() {
        ...
        reportAdmPerState = new javax.swing.JButton();
        ...
        welcome.setText("Administradores de Batalhões por Estado (UF)");
        ...
        jLabel1.setText("Selecione um estado para gerar o relatório: *");
        ...
        reportAdmPerState.setText("Gerar Relatório");
        reportAdmPerState.setPreferredSize(new java.awt.Dimension(150, 40));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(reportAdmPerState, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(324, 324, 324))))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(68, 68, 68)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void reportAdmPerStateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reportAdmPerStateActionPerformed
        try {
            ...
            JasperReport report = JasperCompileManager.compileReport(getClass().getResourceAsStream("/com/brasilsoldado/reports/listBattalionAdmsState.jrxml"));

            Map params = new HashMap();
            params.put("idState", item.getCodigo());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewReportStateBattalion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewReportStateBattalion().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton reportAdmPerState;

 ...
 * @author joaopedro
 */
public class ViewQualificationIndex extends javax.swing.JFrame {

    /**
     * Creates new form VIewQualificationIndex
     */
    public ViewQualificationIndex() {
        QualificationController qualificationController = new QualificationController();
        ArrayList<Qualification> qualifications = qualificationController.index();
        String[] columns = {"id", "type"};
        //this.qualifications = new JTable(qualifications, columns);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jMenu2.setText("Nova Qualificação");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewQualificationIndex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
